...
"""
Over the years, decompositions attempted were:
...
class Decomposition:
    ...
    def __init__(self, s_obj, **kwargs):
        ...
        self.antenna_positions = np.load(tb.P(r'gen_dataset\antenna_positions.npy').absolute_from())
...
class AliDatasetHandler:
    def __init__(self):
        ...
        tmp = self.ali_path.search("*S*.s*", win_order=True)
...
class FeaturePlotter(tb.Artist):
    ...
    def from_dict(my_dict, antenna=0):
        ...
        return tb.VisibilityViewerAuto(data=[data_], titles=titles_, artist=FeaturePlotter(antenna),
                                       ...
                                       save_dir=tb.P('tmp').absolute_from())

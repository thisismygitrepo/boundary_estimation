...
import training.signal_nn.regression_trials as reg
...
path = tb.P(r"saved_models\boundary_models\reduced_freq").absolute_from("deephead")
_ = HParams
...
boundaries = data_path.search("*cal_boundary.npy", r=True).readit(reader=stb.BoundaryDescriptor.from_saved)
